...
export class QuanLiCauHoiComponent {
  ...
  statsData = {
    ...
    unanswered: 13,
    detail: [
      { name: 'Kinh tế xã hội', status: 'Đã trả lời' },
      { name: 'Kỹ năng', status: 'Chưa trả lời' },
      { name: 'Nghiệp vụ', status: 'Đang trả lời' },
      { name: 'Chi nhánh', status: 'Chưa trả lời' },
    ],
  };
